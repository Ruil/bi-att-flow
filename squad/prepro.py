...
def prepro_each(args, data_type, start_ratio=0.0, stop_ratio=1.0, out_name="default", in_path=None):
    ...
    #char_counter
    #   Counter({'e': 344, 't': 314, 'a': 271, 'i': 260, 'r': 185, 'n': 181, 'o': 181, 'h': 153, 'd': 138, 's': 134, 'l': 111, 'c': 95, 'u': 75, 'm': 60, 'f': 59, 'g': 59, 'p': 58, 'M': 43, 'y': 42, '.': 35, ',': 30, 'B': 28, 'A': 20, 'w': 17, 'V': 16, 'S': 16, 'b': 16, 'I': 15, '8': 12, 'G': 11, 'C': 10, '"': 10, 'D': 9, 'N': 9, '1': 6, 'L': 6, 'F': 6, '5': 6, '(': 5, 'v': 5, ')': 5, 'x': 5, '3': 5, "'": 5, 'H': 5, 'O': 5, '?': 5, 'W': 3, 'T': 2})
